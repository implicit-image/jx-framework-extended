...
int JXGetIsAssassinSpell(int iSpellId)
{
    switch (iSpellId)
    {
...
int JXGetIsBlackguardSpell(int iSpellId)
{
    switch (iSpellId)
    {
        case 614: //SPELLABILITY_BG_BULLS_STRENGTH:
        case 613: //SPELLABILITY_BG_CONTAGION:
