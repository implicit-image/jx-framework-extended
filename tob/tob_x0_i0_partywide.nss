//:://////////////////////////////////////////////////
//:: tob_x0_i0_partywide based on X0_I0_PARTYWIDE
...
//:://////////////////////////////////////////////////
// DBR 7/11/06 - Added optional parameter to GetItemPossessedByParty() and GetIsItemPossessedByParty() to allow checking companions as well.
...
//DBR 7/11/06 - added bPlayersOnly, which specifies whether only the possessed party members should be checked.
int GetIsItemPossessedByParty(object oPC, string sItemTag, int bPCOnly=FALSE);

// Check for an item possessed by anyone in the PC's 
// party. If not found, returns OBJECT_INVALID.
//DBR 7/11/06 - added bPlayersOnly, which specifies whether only the possessed party members should be checked.
object GetItemPossessedByParty(object oPC, string sItemTag, int bPCOnly=FALSE);
...
// TRUE if any member of the PC's party has an item with the given tag
// DBR 7/11/06 - Added optional parameter that allows checking for companions as well.
int GetIsItemPossessedByParty(object oPC, string sItemTag, int bPCOnly=FALSE)
{
    return GetIsObjectValid(GetItemPossessedByParty(oPC, sItemTag, bPCOnly));
}
