//:://////////////////////////////////////////////////
//:: tob_x0_i0_combat based on X0_I0_COMBAT
...
//:://////////////////////////////////////////////////
// BMA-OEI 10/12/06 -- SpecialTacticsDefensive(): Check N2_COMBAT_MODE_USE_DISABLED
// EPF 10/20/06 -- SpecialTacticsRanged() will attempt to find extra ammo in inventory 
//				   if none is equipped


#include "tob_x0_i0_talent"
// This file references assets from x0_i0_talent
// as well as x0_i0_enemy, x0_i0_assoc, and x0_i0_equip
...
//Helper for SpecialTacticsRanged() -- returns Ammo of base type nAmmoType
object GetAmmoInInventory(int nAmmoType)
{
...
int SpecialTacticsRanged(object oTarget)
{
	...
	if(nAmmoType >= 0) //need to check for ammo
	{
		...
		{
			oAmmo = GetAmmoInInventory(nAmmoType);
			if(GetIsObjectValid(oAmmo))
			{
...
// JLR - OEI 07/11/05 -- Name Changed
        if (!TrySpell(SPELL_GREATER_INVISIBILITY)) {
...
int SpecialTacticsDefensive(object oTarget)
{
    ...
    int bHasExpertise = GetHasFeat(FEAT_COMBAT_EXPERTISE);
    int bHasImprovedExpertise = GetHasFeat(FEAT_IMPROVED_COMBAT_EXPERTISE);
