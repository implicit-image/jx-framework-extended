...
//:: tob_i0_invocatns based on NW_I0_INVOCATIONS
//:://////////////////////////////////////////////
...
#include "tob_x0_i0_spells"
#include "tob_x2_inc_spellhook"
#include "tob_x2_i0_spells"
...
int GetEldritchBlastDmg(object oCaster, object oTarget, int nAllowReflexSave, int nIgnoreResists, int nHalfDmg, int nTouch/*=1*/)
{
    ...
    if ( nIgnoreResists || (!MyResistSpell(oCaster, oTarget)) )
    {
        ...
        if ( nAllowReflexSave )
        {
            nDmg = Bot9sReflexAdjustedDamage(nDmg, oTarget, GetSpellSaveDC());
        }
    }
