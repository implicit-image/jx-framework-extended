//:://////////////////////////////////////////////////
//:: tob_i0_match based on X0_I0_MATCH
...
//:://////////////////////////////////////////////////
// ChazM 1/12/06 - Evenflw's changes for MatchSingleHandedWeapon() and MatchDoubleHandedWeapon() 
// ChazM 1/16/07 - Evenflw's VerifyCombatMeleeTalent() smite good/evil fix
// ChazM 1/30/07 - added MatchHumanoidRacialType()
// ChazM 2/27/07 - fixed bug in VerifyCombatMeleeTalent() - smite good/evil feat id was being assigned instead of compared.

#include "tob_ginc_debug"
...
int MatchHumanoidRacialType (int nRacialType);
