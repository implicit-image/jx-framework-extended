//:://////////////////////////////////////////////////
//:: tob_x0_i0_transport based on X0_I0_TRANSPORT
...
//:://////////////////////////////////////////////////
// ChazM 5/4/06 - added ClearActionsAndJumpToTag() and ClearActionsAndMoveToTag()
...
// Grab object with GetObjectByTag() and call JumpToObject()
void JumpToObjectByTag(string sObject, string sWaypoint);

// Grab object with GetObjectByTag() and call ActionMoveToObject()
void MoveToObjectByTag(string sObject, string sWaypoint, int bRun = FALSE, float fRange = 1.0f);
...
void ClearActionsAndJumpToTag(string sObject, string sWaypoint)
{
...
void ClearActionsAndMoveToTag(string sObject, string sWaypoint, int bRun = FALSE, float fRange = 1.0f)
{
	object oObject = GetObjectByTag(sObject);
	object oWaypoint = GetObjectByTag(sWaypoint);
