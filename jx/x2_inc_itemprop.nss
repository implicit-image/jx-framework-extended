...
// jallaix 03/23/07 - Corrections in IPGetItemPropertyByID()
// jallaix 04/18/07 - compatibility with patch 1.05
...
*/
    ...
    else if (nPropID == ITEM_PROPERTY_BONUS_HITPOINTS) // 86 (JX comment : it's 66)
    {
